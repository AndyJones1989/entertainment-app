...
export default function Login() {
  ...
  const addInvalidPasswordClass = inputIsValid.password
    ? ""
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className={classes.formWrapper}>
        ...
        <input
          ...
          className={`${classes.formField} ${addInvalidEmailClass}`}
        ></input>
        ...
        <input
          ...
          className={`${classes.formField} ${addInvalidPasswordClass}`}
        ></input>
