   ...
   const handleMenuClick = () => {
    ...
    return(
        ...
        <nav className={classes.wrapper}>
            ...
            <Link href='/' className={classes.burgerElement} >Home</Link>
            <Link href='/landing' className={classes.burgerElement}>Show Activities Near Me</Link>
            <Link href='/post-event' className={classes.burgerElement}>Post an Activity</Link>
            <Link href='/login' className={classes.burgerElement} >Account</Link>
            <button className={classes.burgerClose} onClick={handleMenuClick}>Close</button>
            </ul>
            </>
            }
